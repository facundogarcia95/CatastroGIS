...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="number" id="tipo_mejora_uso_codigo" name="tipo_mejora_uso_codigo" class="form-control" placeholder="Ingrese codigo de estado" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_mejora_uso_descrip" name="tipo_mejora_uso_descrip" class="form-control" placeholder="Ingrese la descripcion" required>

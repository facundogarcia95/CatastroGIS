...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_mejora_destino_descrip" name="tipo_mejora_destino_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_mejora_destino_abrev" name="tipo_mejora_destino_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

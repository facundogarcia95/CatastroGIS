...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_persona_parcela_descrip" name="tipo_persona_parcela_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_persona_parcela_abrev" name="tipo_persona_parcela_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

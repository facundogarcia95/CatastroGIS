...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_documento_descrip" name="tipo_documento_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_documento_abrev" name="tipo_documento_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

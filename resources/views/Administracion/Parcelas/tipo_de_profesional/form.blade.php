...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_profesional_descrip" name="tipo_profesional_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_profesional_abrev" name="tipo_profesional_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

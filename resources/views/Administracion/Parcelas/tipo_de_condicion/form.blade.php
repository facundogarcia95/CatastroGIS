...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_condicion_descrip" name="tipo_condicion_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_condicion_abrev" maxlength="10" name="tipo_condicion_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_instrumento_descrip" name="tipo_instrumento_descrip" class="form-control" placeholder="Ingrese el Nombre" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="tipo_instrumento_abrev" maxlength="10" name="tipo_instrumento_abrev" class="form-control" placeholder="Ingrese el Nombre" required>

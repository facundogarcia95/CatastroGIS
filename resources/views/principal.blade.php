    ...
    <script>
     ...
     /*INICIO ventana modal para cambiar el estado del usuario*/
       ...
       $('#cambiarEstadoVenta').on('show.bs.modal', function (event) {
        ...
        /*INICIO ventana modal para cancelare Venta*/
        
        $('#cancelarVenta').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-body #id_ventaCancelada').val(id_venta);
        })
         
        /*FIN ventana modal para cancelar venta*/
